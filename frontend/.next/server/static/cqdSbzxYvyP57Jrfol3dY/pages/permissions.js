...
var SickButton = external_styled_components_default.a.button.withConfig({
...
var Permissions_Permissions = function Permissions(props) {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    var data = _ref.data,
        loading = _ref.loading,
        error = _ref.error;
    return console.log(data) || external_react_default.a.createElement(CenterMaxWidth["a" /* default */], null, external_react_default.a.createElement(ErrorMessage["a" /* default */], {
      error: error
  ...
  _createClass(UserPermissions, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        }), external_react_default.a.createElement("td", null, external_react_default.a.createElement(styles_SickButton, {
          type: "button",
          disabled: loading,
